...
const TestCaseCardSkeleton: React.FC = () => {
    return (
        <div className="bg-gray-950 rounded-lg shadow-lg border border-gray-800 flex flex-col justify-between p-5 overflow-hidden animate-shimmer">
            <div>
                ...
                <div className="flex gap-2 mb-4">
                    ...
                    <div className="h-5 bg-white/5 rounded-full w-28"></div>
                </div>
            ...
            <div className="border-t border-gray-800/50 mt-4 pt-3 flex justify-between items-center">
